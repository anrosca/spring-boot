...
public class ReportRepository {
    ...
    public Report findById(long reportId) {
        ...
        return jdbcTemplate.queryForObject(sql, Collections.singletonMap("id", reportId), REPORT_ROW_MAPPER);
    }
    ...
    public void deleteById(long reportId) {
        ...
        jdbcTemplate.update(sql,Collections.singletonMap("id", reportId));
    }
}
